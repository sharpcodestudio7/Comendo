...
const styles = {
  pagina: { display: 'flex', gap: '16px', height: 'calc(100vh - 120px)' },
  panelProductos: { width: '240px', backgroundColor: '#1A1A1A', borderRadius: '12px', padding: '16px', display: 'flex', flexDirection: 'column', gap: '8px', overflowY: 'auto', border: '1px solid #333', flexShrink: 0 },
  panelTitulo: { margin: '0 0 12px', color: '#FFFFFF', fontSize: '15px', fontWeight: '700' },
  btnProducto: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px', backgroundColor: '#2A2A2A', border: '1px solid #333', borderRadius: '8px', color: '#999999', cursor: 'pointer', fontSize: '13px', textAlign: 'left', fontWeight: '500', width: '100%', transition: 'all 0.2s ease' },
  btnProductoActivo: { backgroundColor: 'rgba(184,115,51,0.15)', border: '1px solid #B87333', color: '#B87333' },
  badgeInsumos: { backgroundColor: 'rgba(255,255,255,0.1)', borderRadius: '10px', padding: '2px 8px', fontSize: '12px', flexShrink: 0 },
  panelReceta: { flex: 1, backgroundColor: '#1A1A1A', borderRadius: '12px', padding: '20px', overflowY: 'auto', border: '1px solid #333' },
  placeholder: { display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%', color: '#444', fontSize: '15px' },
  recetaHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' },
  btnAgregar: { padding: '8px 16px', backgroundColor: 'transparent', color: '#B87333', border: '1px dashed #B87333', borderRadius: '8px', cursor: 'pointer', fontWeight: '700', fontSize: '13px' },
  btnExportar: { padding: '6px 12px', backgroundColor: 'transparent', color: '#B87333', border: '1px solid #B87333', borderRadius: '6px', cursor: 'pointer', fontWeight: '600', fontSize: '12px' },
  vacio: { color: '#555', fontSize: '14px', fontStyle: 'italic' },
  listaInsumos: { display: 'flex', flexDirection: 'column', gap: '10px' },
  insumoItem: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#2A2A2A', borderRadius: '8px', padding: '12px 14px', border: '1px solid #333' },
  insumoInfo: { display: 'flex', flexDirection: 'column', gap: '4px' },
  insumoNombre: { color: '#FFFFFF', fontWeight: '600', fontSize: '14px' },
  insumoCantidad: { color: '#B87333', fontSize: '13px', fontWeight: '500' },
  btnQuitar: { padding: '6px 12px', backgroundColor: 'transparent', border: '1px solid #8B1A1A', borderRadius: '6px', color: '#ff6b6b', cursor: 'pointer', fontSize: '12px', fontWeight: '600' },
